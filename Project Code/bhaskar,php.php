...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['submit'])) {
    ...
    if ($conn->connect_error) {
        ...
        $stmt = $conn->prepare("INSERT INTO bhaskar (name, email, rating, review) VALUES (?, ?, ?, ?)");
...
<body class="sub_page" >
  ...
  <!-- freelance section -->
   <div class="container">
    ...
    <h2>Bhoothaddam Bhaskar Narayana</h2>
    <img src="images\bhaskar.jpg" alt="Movie Poster"  class="movie_image" height="500" width="500 " ><br>
    <b>Release Date :</b> March 01, 2024<br>
    <b>Starring:</b>  Shiva Kandukuri, Rashi Singh, Devi Prasad, Varshini Soundararajan, Siva Kumar, Shafi, Surabhi Santosh, Sivannarayana, Venkatesh Kakumanu<br>
    <b>Director:</b> Purushotham Raaj<br>
    <b>Producer:</b> Snehal Jangala, Shashidhar Kasi, Karthik Mudimbi<br>
    <b>Music Director:</b> Sricharan Pakala, Vijai Bulganin <br>
    <b>Cinematographer:</b> Goutham G<br>
    <b>Editor:</b> garry<br>

    <p>Shiva Kandukuri has now come up with the film Bhoothaddam Bhaskar Narayana. Directed by Purushotham Raaj, the film hit the screens today. Let’s find out how it is.</p>
  </div>
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <div class="detail-box">
                  ...
                  <p>
                    On the whole, Bhoothaddam Bhaskar Narayana has a fascinating premise, but the narration isn’t great enough to take the film to the next level. The first half looks disjointed as the scenes don’t have a proper connection, but the second half is decent and makes sense. Especially the last few minutes of the film are well executed and offer good thrills. Shiva Kandukuri neatly portrayed the detective role. Had the technical flaws been taken care of, the movie would have been much better. If you are okay with these drawbacks, you can give Bhoothaddam Bhaskar Narayana a try
              ...
              <div class="carousel-item">
               ...
               <div class="carousel-item">
                <div class="detail-box">
                  ...
                  <p>
                    Bhaskar Narayana (Shiva Kandukuri) aspires to be a detective right from his young age, inspired by his elder brother. The story takes an interesting turn when a psychopathic killer commits a series of murders in the Andhra - Karnataka border region.  Women were being brutally murdered decapitating their heads and replacing them with Dishti dolls. Bhaskar Narayana gets into the mission of solving the case. As the story progresses, Bhaskar finds a connection between mythological elements to the murders.  What follows is an intriguing tale blended with thrills and twists unfolding in an interesting manner.
               ...
               <div class="carousel-item">
                <div class="detail-box">
                  ...
                  <p>
                 While Telugu cinema boasts a plethora of crime thrillers, 'Bhoothadham Bhaskar Narayana' injects a fresh perspective by blending mythology with contemporary storytelling.
The director's narrative finesse grips viewers from the outset, with stellar performances enhancing the overall experience.
Shiva Kandukuri effortlessly embodies the role of the protagonist, infusing authenticity into his portrayal.
The storyline maintains suspense throughout, with revelations unfolding at a tantalizing pace.
   ...
   <div class="container">
    <div class="review">
        ...
        if ($conn->connect_error) {
            ...
            $sql = "SELECT * FROM keeda ORDER BY id DESC LIMIT 10"; // Adjust the query as needed
